...
export const removeReview=(id,pid)=>(dispatch)=>{
    ...
    const token=cookie.load("token")
        ...
        axios.post("http://localhost:8000/api/product/review/delete/?idr="+id+"&pid="+pid,{token:token})
...
export const getProduct=(query)=>(dispatch)=>{
        ...
        let queryString="http://localhost:8000/api/product/all?keyword="+query.keyword
...
export const removePA=()=>{
    ...
    return (dispatch)=>{
        ...
        axios.post("http://localhost:8000/api/product/delete/all",{token:token})
        .then(()=>{ 
...
export const removeP=(id)=>{
    ...
    return (dispatch)=>{
        ...
        axios.post("http://localhost:8000/api/product/delete/"+id,{token:token})
        .then((res)=>{ 
...
export const updateProduct=(product)=>(dispatch)=>{
    ...
    axios.post("http://localhost:8000/api/product/update/"+product.id,{...product,token:token}).then(()=>{
...
export const createProduct=(product)=>(dispatch)=>{
    ...
    axios.post("http://localhost:8000/api/product/new",{...product,token:token}).then(()=>{
