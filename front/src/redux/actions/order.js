...
export const removeOrder = (id,order) => {
    return  dispatch => {
        ...
        axios.post(`http://localhost:8000/api/order/remove/${id}`
        ,{token:token})
        .then(()=>{
...
export const updateOrder = (id,status,order) => {
    return  dispatch => {
        ...
        axios.post(`http://localhost:8000/api/order/update/${id}`
...
export const  getAllOrder= () => {
    return  dispatch => {
            ...
            axios.post("http://localhost:8000/api/order/all",{token:token})
            .then((res)=>{
...
export const getMyOrder=()=>(dispatch)=>{
    ...
    axios.post("http://localhost:8000/api/order/me",{token:token})
    .then(res=>{
...
export const getSingleOrder = (idr) => {
    return  dispatch => {
      ...
      axios.post(`http://localhost:8000/api/order/${idr}`,{token:token})
         .then((res)=>{
